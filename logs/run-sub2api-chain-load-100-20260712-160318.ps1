...
$env:SUB2API_DEEPSEEK_API_KEY='sk-placeholder-deepseek'
$env:SUB2API_IMAGE_API_KEY='sk-placeholder-openai'
$env:SUB2API_SEEDANCE_API_KEY='sk-placeholder-seedance'
