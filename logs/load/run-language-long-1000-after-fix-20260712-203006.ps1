...
$env:LOAD_TIMEOUT_MS='1800000'
$env:LOAD_PROGRESS_INTERVAL_MS='10000'
$env:LOAD_REPORT_PATH='docs/diagnostics/2026-07-12-language-long-1000-after-fix-20260712-203006.md'
